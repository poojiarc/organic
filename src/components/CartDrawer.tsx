...
const WHATSAPP_NUMBER = "916363702882"; // Kept the existing number from the original code
              ...
              {items.length === 0 ? (
                <div className="h-full flex flex-col items-center justify-center text-center gap-3 py-20">
                  ...
                  <p className="text-sm text-muted-foreground max-w-xs">
                    Pick something fresh and organic from our store.
                  </p>
                </div>
              ) : (
                <div className="space-y-5">
                    ...
                    {items.map((item) => (
                      ...
                      >
                        {item.image ? (
                          ...
                          <div className="h-20 w-20 rounded-xl bg-secondary flex items-center justify-center text-3xl">
                            {item.emoji ?? "🌿"}
                          </div>
                        )}
                  ...
                  <div className="border-t bg-card/60 pt-5 backdrop-blur-sm">
                    ...
                    <button
                      onClick={checkout}
                      className="mt-3 flex w-full items-center justify-center gap-2 rounded-full bg-green-500 py-3.5 text-sm font-semibold text-white shadow-warm transition-transform hover:scale-[1.01] active:scale-95"
                    >
