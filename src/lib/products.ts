...
export const PRODUCTS: Product[] = [
  ...
  { id: "cashew", name: "Cashew Kolar Nuts", desc: "Locally grown, hand-picked cashews.", category: "by-products", price: 120, unit: "100gm", emoji: "🥜", image: cashewImg },
  { id: "honey", name: "Forest Honey", desc: "Raw, unfiltered forest honey.", category: "by-products", price: 1100, unit: "750ml", emoji: "🍯", image: honeyImg },
